<template>
    <section class="section presentation">
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <h2 class="paragraph-text">Revolutionize agricultural industry</h2>
                </div>
                <div class="col-6">
                    <div class="section-reveal__text">
                    ...
                    <ButtonMain class="mt-12 link" text="Discover our vision" :has-icon="true"/>
                </div>
            </div>
        </div>
    </section>
